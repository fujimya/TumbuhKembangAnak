...
public class ListPerkembangan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvView.setLayoutManager(new GridLayoutManager(ListPerkembangan.this, 1));
    ...
    public void getJSON(){
        ...
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ListPerkembangan.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest("http://balita.alfalaqproject.xyz/Controller_Balita/listperkembangan/"+value);
                return s;
            }
        }
...
//                nama = jo.getString("nama_user");
                ...
                ID.add(""+jo.getString("id_perkembangan"));


                adapter = new AdapterPerkembangan(ListPerkembangan.this,ID,Tanggal,Data);
