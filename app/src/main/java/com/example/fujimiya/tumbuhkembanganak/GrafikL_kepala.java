...
public class GrafikL_kepala extends AppCompatActivity {
    WebView wevView;
    String value;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grafik_l_kepala);
        ...
        wevView.setWebViewClient(new GrafikL_kepala.MyBrowser());
        ...
        wevView.loadUrl("http://balita.alfalaqproject.xyz/Controller_Grafik/lkepala/"+value);

    }

    public void print(View view) {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://balita.alfalaqproject.xyz/Controller_Grafik/lkepala/"+value));
