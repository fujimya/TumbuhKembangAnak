...
public class ListGrafik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_grafik);
        ...
        actionBar.setSubtitle("List Grafik");
        ...
        rvView.setLayoutManager(new GridLayoutManager(ListGrafik.this, 1));
    ...
    public void getJSON(){
        ...
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ListGrafik.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
...
//                nama = jo.getString("nama_user");
                ...
                adapter = new AdapterListGrafik(ListGrafik.this,ID,NamaB,TempatB,TanggalB,JK);
